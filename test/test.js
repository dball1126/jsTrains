...
describe('Case 7: ', () => {
    ...
    it("The number of trips starting at A and ending at C with exactly 4 stops is valid", () => {
...
describe('Case 8: ', () => {
    ...
    it("The length of the shortest route from A to C is valid", () => {
...
describe('Case 9: ', () => {
    ...
    it("The length of the shortest route from B to B is valid", () => {
...
describe('Case 10: ', () => {
    ...
    it("The number of the different routes from C to C with a distance of less than 30 is valid", () => {
